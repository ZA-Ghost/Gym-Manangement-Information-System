...
<html>
    ...
    <body>
		...
		INSERT INTO contract (Name, Surname, IdentityPassportNumber, CellphoneNumber, EmailAddress, HomeAddress, Price, StartDate, EndDate, Package, Status, Comments)
		  VALUES ('${param.name}', '${param.surname}', '${param.identity}', '${param.cellphone}', '${param.email}', 
                  '${param.address}',  '${param.price}', '${param.startDate}', '${param.endDate}', '${param.packages}', '${param.status}', '${param.comments}');
		</sql:update>
